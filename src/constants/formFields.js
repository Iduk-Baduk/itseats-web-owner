...
export const STORE_INFO = [
  ...
  { info: "storeManagerPhone", placeholder: "담당자 연착처 (숫자만 입력)", type: "number" },
...
export const BUSINESS_REGISTRATION = [
  ...
  { info: "menuImage", placeholder: "메뉴판이미지 (최개 10개)", type: "text" },
  { info: "etcImages", placeholder: "기타 이미지 (최개 10개)", type: "text" },
